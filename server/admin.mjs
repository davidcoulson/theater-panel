...
export const FIELDS = [
  ...
  { group: 'Display', key: 'ACCENT_INTENSITY', label: 'Accent weather', type: 'range', min: 0, max: 100, step: 5, default: 50, unit: '%', help: 'How much falls, drifts and flaps over the lobby: 0 is none, 50 is the usual, 100 is a blizzard of bats.' },
